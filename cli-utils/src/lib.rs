...
//! So far it only provides a functions to read a line from stdin.
//! # Examples:
//! ```
...
//! ```
//! # Panics:
//! The `read_stdin` function will panic if it fails to reada line with a maessage "Failed to read input line"
